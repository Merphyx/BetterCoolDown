...
public class KeyHandler
{
    ...
    public static KeyBinding backgroundSwitch;
    ...
    public static void registerKeyInputs()
    {
        ClientTickEvents.END_CLIENT_TICK.register(client ->
        {
            ...
            if (backgroundSwitch.wasPressed())
            {
                RenderHelper.backgroundSwitch();
            }
        });
    }
    ...
    public static void init()
    {
        ...
        backgroundSwitch = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                Database.KeyBindingsInfo.BACKGROUND_SWITCH,
                InputUtil.Type.KEYSYM,
                GLFW.GLFW_KEY_K,
                Database.KeyBindingsInfo.CATEGORY
        ));
