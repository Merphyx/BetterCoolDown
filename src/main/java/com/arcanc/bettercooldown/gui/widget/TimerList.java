...
public class TimerList extends AlwaysSelectedEntryListWidget<TimerList.TimerEntry> {
    ...
    public class TimerEntry extends AlwaysSelectedEntryListWidget.Entry<TimerEntry>
    {
        ...
        public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta)
        {
            ...
            context.drawText(textRenderer, RenderHelper.convertTimeToFormattedString(timer.getTimeLeft()), x + 5 + 16 + 2  + textRenderer.getWidth(timerName) + 2, y + entryHeight / 2 - textRenderer.fontHeight / 2, -1, false);
